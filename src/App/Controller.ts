...
export default class Controller {
  ...
  changeCameraPosition() {
    if (this.keyPressedSet.has("a")) this.camera.updateCameraX(-0.1);
    if (this.keyPressedSet.has("d")) this.camera.updateCameraX(0.1);
    if (this.keyPressedSet.has("w")) this.camera.updateCameraZ(0.1);
    if (this.keyPressedSet.has("s")) this.camera.updateCameraZ(-0.1);
  }
}
