export default class MathUtils {
    ...
    static multiplyDirectionByRotation(R, D) {
    ...
    static reflectVector(R, N) {
        const TwoN = MathUtils.scaleVectorV3(N, 2);
        const RDotN = MathUtils.dotVectorsV3(R, N);
        const Scale2N = MathUtils.scaleVectorV3(TwoN, RDotN);
        const subR = MathUtils.subtractVectors(Scale2N, R);
